...
#echo 'Process Command Line Parameter Verbose Enabled' | tee -a -i $APICLItemplogfilepath
echo 'Process Command Line Parameter Verbose Enabled' >> $APICLItemplogfilepath
echo >> $APICLItemplogfilepath
ProcessCommandLIneParameterVerboseEnable "$@"

#echo 'Process Command Line Parameters and Set Values' | tee -a -i $APICLItemplogfilepath
echo 'Process Command Line Parameters and Set Values' >> $APICLItemplogfilepath
echo >> $APICLItemplogfilepath
ProcessCommandLineParametersAndSetValues "$@"

#echo 'Dump Command Line Parameter Parsing Results' | tee -a -i $APICLItemplogfilepath
echo 'Dump Command Line Parameter Parsing Results' >> $APICLItemplogfilepath
echo >> $APICLItemplogfilepath
dumpcliparmparseresults "$@"
