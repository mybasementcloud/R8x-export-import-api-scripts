#!/bin/bash
#
# SCRIPT Object import using CSV file for API CLI Operations for setting host interfaces
#
...
ScriptName=cli_api_import_object_host-interfaces_from_csv
...
export APICLIobjectstype=host-interfaces
