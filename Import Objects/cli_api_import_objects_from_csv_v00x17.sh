...
#export APICLICSVfile=$APICLIpathbase/csv/$APICLICSVobjecttype'_'$APICLIdetaillvl'_'$APICLICSVfileoutputsufix
export APICLIImportCSVfile=$APICLICSVImportpathbase/$APICLICSVobjecttype'_'$APICLIdetaillvl'_'$APICLICSVfileoutputsufix
