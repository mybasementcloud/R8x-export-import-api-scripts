#!/bin/bash
#
# SCRIPT Object import using CSV file for API CLI Operations for setting groups-with-exclusions
#
...
ScriptName=cli_api_import_object_groups-with-exclusions_from_csv_$APIScriptVersion
