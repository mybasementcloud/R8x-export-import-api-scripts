#!/bin/bash
#
# SCRIPT Object import using CSV file for API CLI Operations for setting security-zones
#
...
ScriptName=cli_api_import_object_networks_from_csv_$APIScriptVersion
