...
#
# Minimum Exports Execution collection with --DO-CPI
#
#
...
ScriptName=_minimum_system_data_exports_with_some_do_cpi
export APIScriptFileNameRoot=_minimum_system_data_exports_with_some_do_cpi
export APIScriptShortName=_minimum_system_data_exports_with_some_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription='Minimum "System Data" Domain Exports Execution collection with some --DO-CPI'
...
export test_script_work_folder=./objects.wip/export_import.wip
