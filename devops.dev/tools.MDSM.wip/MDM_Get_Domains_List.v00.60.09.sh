...
ScriptName=MDM_Get_Domains_List_v$ScriptVersion.v${ScriptVersion}
export APIScriptFileNameRoot=MDM_Get_Domains_List
export APIScriptShortName=MDM_Get_Domains_List
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="MDM Get Domains List"
...
export script_save_json_repo=false
export script_use_json_repo=false
...
echo `${dtzs}`${dtzsep} | tee -a -i $APICLIlogfilepath
