...
ScriptName=cli_api_export_all_domains_special_objects_to_csv
export APIScriptFileNameRoot=cli_api_export_all_domains_special_objects_to_csv
export APIScriptShortName=export_all_domains_special_objects_to_csv
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Export Special Objects from all domains, object export to CSV file for API CLI Operations"
...
export APIScriptJSONActionFilename=${APIScriptActionFilePrefix}.'export_special_objects_to_json'.sh
#export APIScriptJSONActionFilename=${APIScriptActionFilePrefix}'_actions_'${APIScriptVersion}.sh

export APIScriptCSVActionFilename=${APIScriptActionFilePrefix}.'export_special_objects_to_csv'.sh
