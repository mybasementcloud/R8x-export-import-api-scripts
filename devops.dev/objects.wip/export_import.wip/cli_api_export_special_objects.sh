...
#
# SCRIPT Special Object export to JSON (standard and full details), and CSV file for API CLI Operations
#
#
...
ScriptName=cli_api_export_special_objects
export APIScriptFileNameRoot=cli_api_export_special_objects
export APIScriptShortName=export_special_objects
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Special Object export to JSON (standard and full details), and CSV file for API CLI Operations"
