...
ScriptName=cli_api_rename_to_new_name_objects_from_csv
export APIScriptFileNameRoot=cli_api_rename_to_new_name_objects_from_csv
export APIScriptShortName=rename_objects_from_csv
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Object rename to new-name using CSV file for API CLI Operations"
...
export script_main_operation='rename'
...
# -------------------------------------------------------------------------------------------------
# Main Operational repeated proceedure - RenameToNewNameWithSetUpdateSimpleObjects - Rename
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# Operational repeated proceedure - Set-Update Simple Objects - Rename
# -------------------------------------------------------------------------------------------------

# The Operational repeated proceedure - Set-Update - Rename Simple Objects is the meat of the script's simple
# objects releated repeated actions.
#
# For this script the ${APICLIobjecttype} items are set or updated.

RenameToNewNameWithSetUpdateSimpleObjects () {
    #
    ...
    echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} "Rename to new name ${APICLIobjecttype} ${APICLICSVobjecttype} from CSV File : ${APICLIImportCSVfile}" | tee -a -i ${logfilepath}
    ...
    if [ ${errorreturn} != 0 ] ; then
        # Something went wrong, terminate
        echo `${dtzs}`${dtzsep} 'RenameToNewNameWithSetUpdateSimpleObjects : Problem during mgmt_cli set --batch operation! error return = { '${errorreturn}' }' | tee -a -i ${logfilepath}
        #return ${errorreturn}
    fi
    ...
    if [ ${errorreturn} != 0 ] ; then
        # Something went wrong, terminate
        echo `${dtzs}`${dtzsep} 'RenameToNewNameWithSetUpdateSimpleObjects : Problem during publish operation! error return = { '${errorreturn}' }' | tee -a -i ${logfilepath}
        #return ${errorreturn}
    fi
    
    echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} "Done with Rename to new name ${APICLIobjecttype} using CSV File : ${APICLIImportCSVfile}" | tee -a -i ${logfilepath}
...
export scriptactiontext='Rename'
#export scriptformattext='JSON'
export scriptformattext='CSV'
export scriptactiondescriptor='Rename to New Name from CSV'
...
# =================================================================================================
# -------------------------------------------------------------------------------------------------
# START : Main Operational repeated proceedures - Rename Special Objects based on CSV
# -------------------------------------------------------------------------------------------------
...
SpecialObjectsCheckAPIVersionAndExecuteOperation () {
    ...
    if [ $(expr ${APIobjectminversion} '<=' ${CurrentAPIVersion}) -eq 1 ] ; then
        ...
        echo `${dtzs}`${dtzsep} 'Special Objects DO NOT support RENAME operation, so done here...' >> ${logfilepath}
...
# -------------------------------------------------------------------------------------------------
# END : Main Operational repeated proceedures - Rename Special Objects based on CSV
# -------------------------------------------------------------------------------------------------
# =================================================================================================
