...
#
# Common Export Execution collection - test environment
#
#
...
ScriptName=.common_exports.test
export APIScriptFileNameRoot=.common_exports.test
export APIScriptShortName=.common_exports.test
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Common Export Execution collection - test environment"
