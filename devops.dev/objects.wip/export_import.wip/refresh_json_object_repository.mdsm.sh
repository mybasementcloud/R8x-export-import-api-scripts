...
ScriptName=refresh_json_object_repository.mdsm
export APIScriptFileNameRoot=refresh_json_object_repository.mdsm
export APIScriptShortName=refresh_json_object_repository.mdsm
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Refresh JSON Object Repository - MDSM"
