...
#
# SCRIPT Object export to CSV file for API CLI Operations - testing for MDSM - selective enabled objects
#
#
ScriptVersion=00.60.12
ScriptRevision=000
ScriptSubRevision=045
ScriptDate=2022-09-15
...
ScriptName=cli_api_export_objects_to_csv.testing.msdm
export APIScriptFileNameRoot=cli_api_export_objects_to_csv.testing.msdm
export APIScriptShortName=export_objects_to_csv.testing.msdm
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Object export to CSV file for API CLI Operations - testing for MDSM - selective enabled objects"
...
# =================================================================================================
# -------------------------------------------------------------------------------------------------
# START : Main Operational repeated proceedures - Export Special Objects to JSON
# -------------------------------------------------------------------------------------------------
...
case "${domaintarget}" in
    'System Data' )
        #echo `${dtzs}`${dtzsep} 'Current target domain ["'${domaintarget}'"] IS handled for properties ='${APICLIobjecttype} | tee -a -i ${logfilepath}
        SpecialObjectsCheckAPIVersionAndExecuteOperation
        ;;
...
#
# This section was removed from common export scripts and testing export scripts to a dedicated
# Special Objects export script to reduced heavy impact caused by the complex objects export from
# very large base objects, like application-site objects, which numbered upwards from 10,000+ objects
# to process for harvesting the needed data
#
