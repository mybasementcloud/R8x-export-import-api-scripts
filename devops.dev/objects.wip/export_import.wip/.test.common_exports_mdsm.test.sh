...
ScriptName=.common_exports_mdsm.test
export APIScriptFileNameRoot=.common_exports_mdsm.test
export APIScriptShortName=.common_exports_mdsm.test
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Common Export Execution for MDSM collection - test environment"
