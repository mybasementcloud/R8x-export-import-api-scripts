...
./cli_api_export_objects_to_csv.sh -v -r --NOWAIT --RESULTS --NSO --10-TAGS --CSVERR
...
./cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format json --KEEPCSVWIP --SO --DO-CPI
./cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format json --KEEPCSVWIP --NSO --DO-CPI
./cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format json --KEEPCSVWIP --OSO --DO-CPI
...
./cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --SO --10-TAGS --CSVALL
./cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --NSO --10-TAGS --CSVERR
./cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --OSO --10-TAGS --CSVALL
...
./cli_api_export_objects.sh -d "System Data" -v -r --NOWAIT --RESULTS --format json --KEEPCSVWIP --SO
./cli_api_export_objects_to_csv.sh -d "System Data" -r -v --NOWAIT --RESULTS --JSONREPO --SO --10-TAGS --CSVALL
./cli_api_export_special_objects_to_csv.sh -d "System Data" -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --SO --10-TAGS --CSVALL
