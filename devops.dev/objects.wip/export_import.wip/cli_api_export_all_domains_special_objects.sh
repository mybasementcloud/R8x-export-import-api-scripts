...
#
# SCRIPT Export special objects from all domains, object export to JSON (standard and full details), and CSV file for API CLI Operations
#
#
...
ScriptName=cli_api_export_all_domains_special_objects
export APIScriptFileNameRoot=cli_api_export_all_domains_special_objects
export APIScriptShortName=export_all_domains_special_objects
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Export Special Objects from all domains, object export to JSON (standard and full details), and CSV file for API CLI Operations"
