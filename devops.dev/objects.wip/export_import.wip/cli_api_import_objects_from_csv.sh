...
ConfigureSetComplexObjects () {
    ...
    echo `${dtzs}`${dtzsep} 'ConfigureSetComplexObjects procedure returns :  '${errorreturn} >> ${logfilepath}
    echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
...
ConfigureImportComplexObjects () {
    ...
    echo `${dtzs}`${dtzsep} 'ConfigureImportComplexObjects procedure returns :  '${errorreturn} >> ${logfilepath}
    echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
