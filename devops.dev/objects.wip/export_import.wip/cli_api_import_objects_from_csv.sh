...
ConfigureComplexObjects () {
    ...
    echo `${dtzs}`${dtzsep} "Import and set ${APICLIobjecttype} ${APICLICSVobjecttype} from CSV File : ${APICLIImportCSVfile}"
    echo `${dtzs}`${dtzsep} "  mgmt_cli parameters : ${MgmtCLI_Set_OpParms}"
    echo `${dtzs}`${dtzsep} "  and dump to ${OutputPath}"
    echo `${dtzs}`${dtzsep}
    ...
    echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} "Done with Importing ${APICLIobjecttype} using CSV File : ${APICLIImportCSVfile}"
...
# -------------------------------------------------------------------------------------------------
# Generic OBJECT Members : RADIUS Group Members
# -------------------------------------------------------------------------------------------------
