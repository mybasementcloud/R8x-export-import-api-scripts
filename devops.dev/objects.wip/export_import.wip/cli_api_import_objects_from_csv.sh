...
export script_main_operation='import'
...
# -------------------------------------------------------------------------------------------------
# Configure mgmt_cli operational show parameters - ConfigureMgmtCLIOperationalParametersImport
# -------------------------------------------------------------------------------------------------
...
#
ConfigureMgmtCLIOperationalParametersImport () {
    #
    # Configure mgmt_cli operational show parameters
    #
    ...
    if ${APISCRIPTVERBOSE} ; then
        echo `${dtzs}`${dtzsep} '--------------------------------------------------------------------------' >> ${logfilepath}
        echo `${dtzs}`${dtzsep} 'Procedure ConfigureMgmtCLIOperationalParametersImport Starting!' >> ${logfilepath}
        echo `${dtzs}`${dtzsep} '--------------------------------------------------------------------------' >> ${logfilepath}
    fi
    ...
    if ${APIobjectusesdetailslevel} ; then
        export MgmtCLI_Add_OpParms='details-level "'${WorkingAPICLIdetaillvl}'" '${MgmtCLI_IgnoreErr_OpParms}' '${MgmtCLI_Base_OpParms}
    else
        export MgmtCLI_Add_OpParms=${MgmtCLI_IgnoreErr_OpParms}' '${MgmtCLI_Base_OpParms}
    fi
    
    if [ $(expr ${CurrentAPIVersion} '>=' 1.1 ) -eq 1 ] ; then
        if ${APIobjectcansetifexists} ; then
            export MgmtCLI_Add_OpParms="set-if-exists true ${MgmtCLI_Add_OpParms}"
        fi
    fi
    
    #if ${APIobjectderefgrpmem} ; then
        #export MgmtCLI_Add_OpParms='dereference-group-members true '${MgmtCLI_Show_OpParms}
    #fi
    ...
    if ${APISCRIPTVERBOSE} ; then
        ...
        echo -n `${dtzs}`${dtzsep} '    - ' >> ${logfilepath}; printf "%-40s %s" 'APIobjectcansetifexists' ' : ' >> ${logfilepath} ; echo ${APIobjectcansetifexists} >> ${logfilepath}
        echo -n `${dtzs}`${dtzsep} '    - ' >> ${logfilepath}; printf "%-40s %s" 'MgmtCLI_Add_OpParms' ' : ' >> ${logfilepath} ; echo ${MgmtCLI_Add_OpParms} >> ${logfilepath}
        echo `${dtzs}`${dtzsep} '--------------------------------------------------------------------------' >> ${logfilepath}
        echo `${dtzs}`${dtzsep} 'Procedure ConfigureMgmtCLIOperationalParametersImport completed!  errorreturn :  !{ '${errorreturn}' }!' >> ${logfilepath}
        echo `${dtzs}`${dtzsep} '--------------------------------------------------------------------------' >> ${logfilepath}
    fi
...
ImportSimpleObjects () {
    ...
    if ! ${APIobjectdoimport} ; then
        echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} 'Object '${APICLIobjecttype}' does NOT support IMPORT!  APIobjectdoimport = '${APIobjectdoimport} | tee -a -i ${logfilepath}
    ...
    export OutputPath=${APICLIpathexport}/${APICLIfileexportpre}'add_'${APICLIobjecttype}'_results.'${APICLIfileexportext}
    ...
    echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} "Import ${APICLIobjecttype} from CSV File : ${APICLIImportCSVfile}" | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} "  mgmt_cli parameters : $MgmtCLI_Add_OpParms" | tee -a -i ${logfilepath}
    ...
    if [ ${errorreturn} != 0 ] ; then
        # Something went wrong, terminate
        echo `${dtzs}`${dtzsep} 'ImportSimpleObjects : Problem during mgmt_cli add --batch operation! error return = { '${errorreturn}' }' | tee -a -i ${logfilepath}
        #return ${errorreturn}
    fi
    ...
    if [ ${errorreturn} != 0 ] ; then
        # Something went wrong, terminate
        echo `${dtzs}`${dtzsep} 'ImportSimpleObjects : Problem during publish operation! error return = { '${errorreturn}' }' | tee -a -i ${logfilepath}
        #return ${errorreturn}
    fi
    
    echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} "Done with Importing ${APICLIobjecttype} using CSV File : ${APICLIImportCSVfile}" | tee -a -i ${logfilepath}
...
export scriptactiontext='Import'
#export scriptformattext='JSON'
export scriptformattext='CSV'
export scriptactiondescriptor='Import from CSV'
...
# =================================================================================================
# -------------------------------------------------------------------------------------------------
# START : Main Operational repeated proceedures - Import Special Objects based on CSV
# -------------------------------------------------------------------------------------------------
...
SpecialObjectsCheckAPIVersionAndExecuteOperation () {
    ...
    if [ $(expr ${APIobjectminversion} '<=' ${CurrentAPIVersion}) -eq 1 ] ; then
        ...
        echo `${dtzs}`${dtzsep} 'SpecialObjectsCheckAPIVersionAndExecuteOperation call to SetUpdateSimpleObjects procedure returned :  !{ '${errorreturn}' }!' >> ${logfilepath}
...
# -------------------------------------------------------------------------------------------------
# END : Main Operational repeated proceedures - Import Special Objects based on CSV
# -------------------------------------------------------------------------------------------------
# =================================================================================================
...
# -------------------------------------------------------------------------------------------------
# Operational repeated proceedure - ConfigureSetComplexObjects -Configure and Set Complex Objects
# -------------------------------------------------------------------------------------------------

# The Operational repeated proceedure - Configure and Set Complex Objects is the meat of the script's
# complex objects releated repeated actions.
#
# For this script the ${APICLIobjecttype} items are set or updated.

# MODIFIED 2023-02-26:02 \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
#

ConfigureSetComplexObjects () {
    #
    # Configure and Set Complex Objects
    ...
    #export script_main_operation='X'
    
    case "${script_main_operation}" in
        'import' )
            if ! ${APIobjectdoimport} ; then
                echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} 'Object '${APICLIcomplexobjectstype}' does NOT support ADD [IMPORT]!  APIobjectdoexport = '${APIobjectdoexport} | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} 'Skipping!' | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
            ...
            ;;
        'set-update' )
            if ! ${APIobjectdoupdate} ; then
                echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} 'Object '${APICLIcomplexobjectstype}' does NOT support RENAME-to-NAME [UPDATE]!  APIobjectdoexport = '${APIobjectdoexport} | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} 'Skipping!' | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
                echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
        ...
        * )
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Unknown Script Main Operation type '${script_main_operation} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Skipping!' | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
    ...
    if ! ${APIobjectdoupdate} ; then
        echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} 'Object '${APICLIcomplexobjectstype}' does NOT support SET [UPDATE]!  APIobjectdoexport = '${APIobjectdoexport} | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} 'Skipping!' | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
    ...
    if [ ${errorreturn} != 0 ] ; then
        ...
        if ${ABORTONERROR} ; then
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Error { '${errorreturn}' } in ConfigureSetComplexObjects procedure' | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            read -t ${WAITTIME} -n 1 -p "Any key to EXIT script due to error ${errorreturn}.  Automatic EXIT after ${WAITTIME} seconds : " anykey
            echo
            ...
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Error { '${errorreturn}' } in ConfigureSetComplexObjects procedure, but continueing' | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            #return ${errorreturn}
        fi
    fi
    
    echo `${dtzs}`${dtzsep} 'ConfigureSetComplexObjects procedure errorreturn :  !{ '${errorreturn}' }!' | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
...
# -------------------------------------------------------------------------------------------------
# Operational repeated proceedure - ConfigureAddComplexObjects -Configure and Add Complex Objects
# -------------------------------------------------------------------------------------------------

# The Operational repeated proceedure - Configure and Add Complex Objects is the meat of the script's
# complex objects releated repeated actions.
#
# For this script the ${APICLIobjecttype} items are added [imported].

# MODIFIED 2023-02-26:01 \/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
#

ConfigureImportComplexObjects () {
    #
    ...
    if [ $(expr ${APIobjectminversion} '<=' ${CurrentAPIVersion}) -eq 1 ] ; then
        ...
        echo `${dtzs}`${dtzsep} 'Add [Import] '${APICLIcomplexobjectstype}' '${APICLICSVobjecttype}' from CSV File : "'${APICLIImportCSVfile}'"' | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} '  mgmt_cli parameters : "'${MgmtCLI_Set_OpParms}'"' | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} '  and dump to "'${OutputPath}'"' | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
        
        mgmt_cli add ${APICLIobjecttype} --batch ${APICLIImportCSVfile} ${MgmtCLI_Set_OpParms} > ${OutputPath}
        errorreturn=$?
        ...
        echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
        echo `${dtzs}`${dtzsep} "Done with Adding [Importing] ${APICLIobjecttype} using CSV File : ${APICLIImportCSVfile}"
    ...
    if [ ${errorreturn} != 0 ] ; then
        ...
        if ${ABORTONERROR} ; then
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Error { '${errorreturn}' } in ConfigureImportComplexObjects procedure' | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            read -t ${WAITTIME} -n 1 -p "Any key to EXIT script due to error ${errorreturn}.  Automatic EXIT after ${WAITTIME} seconds : " anykey
            echo
            ...
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} 'Error { '${errorreturn}' } in ConfigureImportComplexObjects procedure, but continueing' | tee -a -i ${logfilepath}
            echo `${dtzs}`${dtzsep} | tee -a -i ${logfilepath}
            #return ${errorreturn}
        fi
    fi
    
    echo `${dtzs}`${dtzsep} 'ConfigureImportComplexObjects procedure errorreturn :  !{ '${errorreturn}' }!' | tee -a -i ${logfilepath}
    echo `${dtzs}`${dtzsep} '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-' | tee -a -i ${logfilepath}
...
if ${APISCRIPTVERBOSE} ; then
    ...
    if [ x"${APICLIlogpathbase}" != x"" ] ; then
        if [ "${APICLIlogpathbase}" != "${APICLIpathbase}" ] ; then
            echo `${dtzs}`${dtzsep} 'Files in ${APICLIlogpathbase} >'"${APICLIlogpathbase}"'<' | tee -a -i ${logfilepath}
            echo '-------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
    ...
    echo `${dtzs}`${dtzsep} 'Files in ${APICLIpathbase} >'"${APICLIpathbase}"'<' | tee -a -i ${logfilepath}
    echo '-------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
    ...
    if ${UseJSONRepo} ; then
        echo `${dtzs}`${dtzsep} 'Files in JSON Repository ${JSONRepopathroot} >'"${JSONRepopathroot}"'<' | tee -a -i ${logfilepath}
        echo '-------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
    ...
    if [ x"${APICLIlogpathbase}" != x"" ] ; then
        if [ "${APICLIlogpathbase}" != "${APICLIpathbase}" ] ; then
            echo `${dtzs}`${dtzsep} 'Files in ${APICLIlogpathbase} >'"${APICLIlogpathbase}"'<' >> ${logfilepath}
            echo '-------------------------------------------------------------------------------' >> ${logfilepath}
    ...
    echo `${dtzs}`${dtzsep} 'Files in ${APICLIpathbase} >'"${APICLIpathbase}"'<' >> ${logfilepath}
    echo '-------------------------------------------------------------------------------' >> ${logfilepath}
    ...
    if ${UseJSONRepo} ; then
        echo `${dtzs}`${dtzsep} 'Files in JSON Repository ${JSONRepopathroot} >'"${JSONRepopathroot}"'<' >> ${logfilepath}
        echo '-------------------------------------------------------------------------------' >> ${logfilepath}
