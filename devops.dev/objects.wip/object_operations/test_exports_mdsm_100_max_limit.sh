...
#
# Test Export Execution for MDSM collection 100 object max limit - test environment
#
#
...
ScriptName=test_exports_mdsm_100_max_limit
export APIScriptFileNameRoot=test_exports_mdsm_100_max_limit
export APIScriptShortName=test_exports_mdsm_100_max
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export Execution MDSM collection 100 object max limit"
