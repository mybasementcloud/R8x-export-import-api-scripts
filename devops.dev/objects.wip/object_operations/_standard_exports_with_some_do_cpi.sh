...
ScriptName=_standard_exports_with_some_do_cpi
export APIScriptFileNameRoot=_standard_exports_with_some_do_cpi
export APIScriptShortName=_standard_exports_some_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Standard Export Execution collection with some --DO-CPI"
