...
ScriptName=refresh_all_json_object_repositories_mdsm_100_max_limit
export APIScriptFileNameRoot=refresh_all_json_object_repositories_mdsm_100_max_limit
export APIScriptShortName=refresh_all_json_object_repositories_mdsm_100_max
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Refresh ALL JSON Object Repositories [-SO, -NSO, -OSO] -  - MDSM 100 object max limit"
