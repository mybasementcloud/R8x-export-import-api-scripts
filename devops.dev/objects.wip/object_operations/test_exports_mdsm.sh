...
ScriptName=test_exports_mdsm
export APIScriptFileNameRoot=test_exports_mdsm
export APIScriptShortName=test_exports_mdsm
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export Execution MDSM collection"
