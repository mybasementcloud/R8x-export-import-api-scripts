...
#
# Test JSON Export Execution for MDSM collection - test environment
#
#
...
ScriptName=test_exports_json_mdsm
export APIScriptFileNameRoot=test_exports_json_mdsm
export APIScriptShortName=test_exports_json_mdsm
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export to JSON Execution MDSM collection"
