...
ScriptName=common_csv_exports
export APIScriptFileNameRoot=common_csv_exports
export APIScriptShortName=common_csv_exports
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Common CSV Export Execution collection"
