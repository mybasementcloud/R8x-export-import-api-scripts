...
ScriptName=other_main_exports_mdsm
export APIScriptFileNameRoot=other_main_exports_mdsm
export APIScriptShortName=other_main_exports
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Other Main Exports Execution for MDSM collection"
