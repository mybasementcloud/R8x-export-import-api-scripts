...
ScriptName=test_exports_json
export APIScriptFileNameRoot=test_exports_json
export APIScriptShortName=test_exports_json
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export to JSON Execution collection"
