...
ScriptName=refresh_json_object_repository_mdsm
export APIScriptFileNameRoot=refresh_json_object_repository_mdsm
export APIScriptShortName=refresh_json_object_repository_mdsm
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Refresh JSON Object Repository (-SO) - MDSM"
