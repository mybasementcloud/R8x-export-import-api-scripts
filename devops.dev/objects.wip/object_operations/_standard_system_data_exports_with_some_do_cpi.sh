...
ScriptName=_standard_system_data_exports_with_some_do_cpi
export APIScriptFileNameRoot=_standard_system_data_exports_with_some_do_cpi
export APIScriptShortName=_standard_system_data_exports_with_some_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Standard Export Execution for domain "'"System Data"'" collection with some --DO-CPI"
