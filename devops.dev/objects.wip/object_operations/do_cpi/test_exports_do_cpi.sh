...
ScriptName=test_exports_do_cpi
export APIScriptFileNameRoot=test_exports_do_cpi
export APIScriptShortName=test_exports_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export Execution collection with --DO-CPI"
