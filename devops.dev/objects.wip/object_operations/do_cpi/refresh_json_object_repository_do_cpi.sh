...
ScriptName=refresh_json_object_repository_do_cpi
export APIScriptFileNameRoot=refresh_json_object_repository_do_cpi
export APIScriptShortName=refresh_json_object_repository_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Refresh JSON Object Repository (-SO)- SMS with --DO-CPI"
...
#
#export TESTOPSARRAY+=("cli_api_export_all_domains_objects.sh -v -r --NOWAIT --RESULTS --format all --KEEPCSVWIP --SO --10-TAGS --CSVALL --DO-CPI")
#export TESTOPSARRAY+=("cli_api_export_all_domains_objects.sh -v -r --NOWAIT --RESULTS --format all --KEEPCSVWIP --NSO --10-TAGS --CSVERR --DO-CPI")
#export TESTOPSARRAY+=("cli_api_export_all_domains_objects.sh -v -r --NOWAIT --RESULTS --format all --KEEPCSVWIP --OSO --10-TAGS --CSVALL --DO-CPI")
...
#export TESTOPSARRAY+=("cli_api_export_all_domains_objects.sh -r -v --NOWAIT --RESULTS --format json --KEEPCSVWIP --NSO --DO-CPI")
#export TESTOPSARRAY+=("cli_api_export_all_domains_objects.sh -r -v --NOWAIT --RESULTS --format json --KEEPCSVWIP --OSO --DO-CPI")
...
#export TESTOPSARRAY+=("cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --SO --10-TAGS --CSVALL --DO-CPI")
...
#export TESTOPSARRAY+=("cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --OSO --10-TAGS --CSVALL --DO-CPI")
