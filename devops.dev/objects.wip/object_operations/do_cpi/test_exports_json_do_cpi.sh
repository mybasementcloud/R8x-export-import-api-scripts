...
#
# Test JSON Export Execution collection - test environment
#
#
...
ScriptName=test_exports_json_do_cpi
export APIScriptFileNameRoot=test_exports_json_do_cpi
export APIScriptShortName=test_exports_json_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export to JSON Execution collection with --DO-CPI"
