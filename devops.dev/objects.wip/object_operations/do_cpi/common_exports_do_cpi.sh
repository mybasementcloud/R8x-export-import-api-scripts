...
ScriptName=common_exports_do_cpi
export APIScriptFileNameRoot=common_exports_do_cpi
export APIScriptShortName=common_exports_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Common Export Execution collection with --DO-CPI"
