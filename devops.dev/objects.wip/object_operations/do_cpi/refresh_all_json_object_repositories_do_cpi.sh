...
ScriptName=refresh_all_json_object_repositories_do_cpi
export APIScriptFileNameRoot=refresh_all_json_object_repositories_do_cpi
export APIScriptShortName=refresh_all_json_object_repositories_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Refresh ALL JSON Object Repositories [-SO, -NSO, -OSO] - SMS with --DO-CPI"
