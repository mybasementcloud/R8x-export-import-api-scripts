...
ScriptName=test_exports_csv_do_cpi
export APIScriptFileNameRoot=test_exports_csv_do_cpi
export APIScriptShortName=test_exports_csv_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export to CSV Execution collection with --DO-CPI"
