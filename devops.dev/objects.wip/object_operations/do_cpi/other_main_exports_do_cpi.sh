...
ScriptName=other_main_exports_do_cpi
export APIScriptFileNameRoot=other_main_exports_do_cpi
export APIScriptShortName=other_main_exports_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Other Main Exports Execution collection with --DO-CPI"
