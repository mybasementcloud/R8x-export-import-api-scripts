...
ScriptName=common_csv_exports_do_cpi
export APIScriptFileNameRoot=common_csv_exports_do_cpi
export APIScriptShortName=common_csv_exports_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Common CSV Export Execution collection with --DO-CPI"
