...
#
# Test CSV Export Execution for MDSM collection - test environment
#
#
...
ScriptName=test_exports_csv_mdsm
export APIScriptFileNameRoot=test_exports_csv_mdsm
export APIScriptShortName=test_exports_csv_mdsm
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export to CSV Execution MDSM collection"
