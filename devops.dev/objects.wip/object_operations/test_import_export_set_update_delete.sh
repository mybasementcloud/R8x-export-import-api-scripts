...
ScriptName=test_import_export_set_update_delete
export APIScriptFileNameRoot=test_import_export_set_update_delete
export APIScriptShortName=test_import_export_set_update_delete
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Import Export Set-Update Delete Execution collection - test environment - SMS"
