...
ScriptName=refresh_all_json_object_repositories
export APIScriptFileNameRoot=refresh_all_json_object_repositories
export APIScriptShortName=refresh_all_json_object_repositories
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Refresh ALL JSON Object Repositories [-SO, -NSO, -OSO] - SMS"
