...
#
# Common CSV Export Execution for MDSM collection 100 object max limit
#
#
...
ScriptName=common_csv_exports_mdsm_100_max_limit
export APIScriptFileNameRoot=common_csv_exports_mdsm_100_max_limit
export APIScriptShortName=common_csv_exports_mdsm_100_max
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Common Export Execution for MDSM collection 100 object max limit"
