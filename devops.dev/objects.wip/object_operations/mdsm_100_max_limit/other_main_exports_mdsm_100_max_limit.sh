...
ScriptName=other_main_exports_mdsm_100_max_limit
export APIScriptFileNameRoot=other_main_exports_mdsm_100_max_limit
export APIScriptShortName=other_main_exports_mdsm_100_max
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Other Main Exports Execution for MDSM collection 100 object max limit"
