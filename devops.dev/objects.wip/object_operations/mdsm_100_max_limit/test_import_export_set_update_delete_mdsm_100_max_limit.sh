...
#
# Test Import Export Set-Update Delete Execution collection - test environment - MDSM 100 object max limit
#
#
...
ScriptName=test_import_export_set_update_delete_mdsm_100_max_limit
export APIScriptFileNameRoot=test_import_export_set_update_delete_mdsm_100_max_limit
export APIScriptShortName=test_import_export_set_update_delete_mdsm_100_max
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Import Export Set-Update Delete Execution collection - test environment 100 object max limit"
