...
#
# Test JSON Export Execution for MDSM collection 100 object max limit - test environment
#
#
...
ScriptName=test_exports_json_mdsm_100_max_limit
export APIScriptFileNameRoot=test_exports_json_mdsm_100_max_limit
export APIScriptShortName=test_exports_json_mdsm_100_max
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Test Export to JSON Execution MDSM collection 100 object max limit"
