...
ScriptName=common_exports_mdsm_100_max_limit
export APIScriptFileNameRoot=common_exports_mdsm_100_max_limit
export APIScriptShortName=common_exports_mdsm_100_max
