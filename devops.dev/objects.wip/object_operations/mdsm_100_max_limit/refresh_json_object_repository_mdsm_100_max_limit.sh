...
#
# Refresh JSON Object Repository - MDSM 100 object max limit
#
#
...
ScriptName=refresh_json_object_repository_mdsm_100_max_limit
export APIScriptFileNameRoot=refresh_json_object_repository_mdsm_100_max_limit
export APIScriptShortName=refresh_json_object_repository_mdsm_100_max
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Refresh JSON Object Repository (-SO) - MDSM 100 object max limit"
...
#
#export TESTOPSARRAY+=("cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format all --KEEPCSVWIP --SO --10-TAGS --CSVALL --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
#export TESTOPSARRAY+=("cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format all --KEEPCSVWIP --NSO --10-TAGS --CSVERR --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
#export TESTOPSARRAY+=("cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format all --KEEPCSVWIP --OSO --10-TAGS --CSVALL --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")

#
# JSON only Exports, builds JSON Repository
#
export TESTOPSARRAY+=("cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format json --KEEPCSVWIP --SO --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
#export TESTOPSARRAY+=("cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format json --KEEPCSVWIP --NSO --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
#export TESTOPSARRAY+=("cli_api_export_objects.sh -v -r --NOWAIT --RESULTS --format json --KEEPCSVWIP --OSO --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
...
#export TESTOPSARRAY+=("cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --SO --10-TAGS --CSVALL --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
#export TESTOPSARRAY+=("cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --NSO --10-TAGS --CSVERR --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
#export TESTOPSARRAY+=("cli_api_export_special_objects_to_csv.sh -r -v --NOWAIT --RESULTS --JSONREPO --KEEPCSVWIP --OSO --10-TAGS --CSVALL --OVERRIDEMAXOBJECTS --MAXOBJECTS 100")
