...
#
# Minimum Exports Execution collection
#
#
...
ScriptName=_minimum_exports
export APIScriptFileNameRoot=_minimum_exports
export APIScriptShortName=_minimum_exports
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Minimum Exports Execution collection"
