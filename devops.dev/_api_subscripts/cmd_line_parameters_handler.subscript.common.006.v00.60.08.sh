...
dumpcliparmparseresults () {
    ...
    echo `${dtzs}`${dtzsep} 'CLI Parameters :' >> ${subscriptstemplogfilepath}
    ...
    printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'CLIparm_api_context' "${CLIparm_api_context}" >> ${subscriptstemplogfilepath}
    printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'CLIparm_use_api_context' "${CLIparm_use_api_context}" >> ${subscriptstemplogfilepath}
    ...
    printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'CLIparm_UseJSONRepo' "${CLIparm_UseJSONRepo}" >> ${subscriptstemplogfilepath}
    printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'CLIparm_SaveJSONRepo' "${CLIparm_SaveJSONRepo}" >> ${subscriptstemplogfilepath}
    printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'CLIparm_ForceJSONRepoRebuild' "${CLIparm_ForceJSONRepoRebuild}" >> ${subscriptstemplogfilepath}
    printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'CLIparm_jsonrepopath' "${CLIparm_jsonrepopath}" >> ${subscriptstemplogfilepath}
    #printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'UseJSONRepo' "${UseJSONRepo}" >> ${subscriptstemplogfilepath}
    #printf "`${dtzs}`${dtzsep}%-40s = %s\n" 'SaveJSONRepo' "${SaveJSONRepo}" >> ${subscriptstemplogfilepath}
