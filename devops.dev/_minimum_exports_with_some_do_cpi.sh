...
ScriptName=_minimum_exports_with_some_do_cpi
export APIScriptFileNameRoot=_minimum_exports_with_some_do_cpi
export APIScriptShortName=_minimum_exports_with_some_do_cpi
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Minimum Exports Execution collection with some --DO-CPI"
